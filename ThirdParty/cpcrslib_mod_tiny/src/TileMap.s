...
;    add ix,sp									;4
;    ld l,0 (ix)								;5
;    ld h,1 (ix)	;HL apunta al sprite		;5
...
;1. se marcan los tiles correspondientes como tocados para luego redibujar.
	...
	CALL bucle_restauracion_fondo   ; Posición anterior
...
bit_ancho:	; *parametro
    ...
    add c	;x+ancho
    srl a	;/2
    ;jp nc, lop2	;si c entonces hay un bloque más			; 3 NOP
    ;inc a    													; 1 NOP
    adc #0		; para sumar C									; 1 NOP
lop2:    
    sub e
cont_proceso:

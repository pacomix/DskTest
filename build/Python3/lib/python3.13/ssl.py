...
if os.name == "nt":
    ...
    _portable_python_certifi_path = os.path.join(sys.prefix, "lib", f"python{sys.version_info.major}.{sys.version_info.minor}{sys.abiflags}", "site-packages", "certifi", "cacert.pem")
...
def create_default_context(purpose=Purpose.SERVER_AUTH, *, cafile=None,
    ...
    if cafile is None:
        if os.path.exists(_portable_python_certifi_path):
